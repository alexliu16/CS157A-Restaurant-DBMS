...
public class RestaurantOwnerMainView extends HorizontalLayout implements View{
	...
	private void buildMenu() {
		...
		//create buttons
		String[] buttonNames = new String[]{"View Profile", "Edit Profile", "Change Password", "View Menu", "View Employee Information", "Hire New Employee", "Logout"};
		...
		editProfileButton.addClickListener(new Button.ClickListener() {
			...
			@Override
			public void buttonClick(ClickEvent event) {
				navigator.navigateTo("OwnerEditProfileView");
				((OwnerEditProfileView)navigator.getCurrentView()).setEmployee(employee);
				((OwnerEditProfileView)navigator.getCurrentView()).displayInitialContent();
			}
		});
		...
		changePasswordButton.addClickListener(new Button.ClickListener() {
			...
			@Override
			public void buttonClick(ClickEvent event) {
				navigator.navigateTo("OwnerChangePasswordView");
				((OwnerChangePasswordView)navigator.getCurrentView()).setEmployee(employee);
			}
		});
		
		Button menuButton = buttons.get(3);
		...
		Button employeesButton = buttons.get(4);
		employeesButton.setIcon(VaadinIcons.USERS);
		employeesButton.addClickListener(new Button.ClickListener() {
			
			@Override
			public void buttonClick(ClickEvent event) {
				navigator.navigateTo("AllEmployeesView");
				((AllEmployeesView)navigator.getCurrentView()).update();
				((AllEmployeesView)navigator.getCurrentView()).setEmployee(employee);
			}
		});
		
		Button hireButton = buttons.get(5);
		hireButton.setIcon(VaadinIcons.PLUS);
		hireButton.addClickListener(new Button.ClickListener() {
			
			@Override
			public void buttonClick(ClickEvent event) {
				navigator.navigateTo("HireEmployeeView");
				((HireEmployeeView)navigator.getCurrentView()).setEmployee(employee);
		...
		menuItemsLayout.addComponents(labels.get(2), employeesButton, hireButton);
